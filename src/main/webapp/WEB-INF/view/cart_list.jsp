...
<script type="text/javascript" src="js/food_cart.js"></script>			
<style type="text/css">
.tb_order_style{
    width:100%;
}
				...
				<div class="content" id="content">
					<div id="cart">
						...
						<input type="hidden" name="exec" value> <input
							type="hidden" name="extend_mode" value="subscription">
						<table class="tb_order_style cart">
			                  ...
			                  <td><input type="checkbox" id="cart_item" name="cart_item" class="bf hidden_chk" value="<%=i%>"></td>
			                     <td style="text-align: right !important;"><a href="#"><img src="product/<%= res.getCl_img()%>" style="width: 50px; hight: 40px;"></a></td>
			                     <td style="text-align: left !important;"><%=res.getCl_menu()%></td>
			                     <td class="cart_price<%=i%>"><%=res.getCl_price()%></td>
			                     <td>
			                     <label>
			                        <input type="number" class="buy_cnt_<%=i%>" min="1" max="999" value="<%=res.getCl_quantity()%>" />
			                     </label> 
			                     <span>
			                        <a href="#" title="수량 더하기" class="up"></a> 
			                        <a href="#" title="수량 빼기" class="down"></a>
			                     </span>
			                     <a class="cart_list_btn" href="javascript:cartcnt(<%=i%>)"><span>변경</span></a>
			                     </td>
			                     <td class="cart_sum_price<%=i%>"><%=res.getCl_totalprice()%></td>
			                     <td>
			                     <div class="bill_date" draggable="false">
			                     ...
			                     <td><a class="cart_list_del btn" href="javascript:cartdel(<%=i%>)">삭제하기</a></td>
			                  </tr>
			                  <%
							...
							<div class="purchase_price">
								...
								<div class="box">
									...
									<dl class="total">
										<dt>구매 내역</dt>
										<dd>
											<span class="number" pricedata="" id="totalPrice"><%=total_price %></span>
						...
						<div class="btn-area cart">
							<a href="foodindex.do" class="btn_white"
								onmouseover="this.style.background='#f2f2f2';"
								onmouseout="this.style.background='#fff';">계속 쇼핑
							</a> <a href="loginform.do"
								onclick="alert()" class="btn_mint"
