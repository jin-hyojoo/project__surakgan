...
insert into users(u_no, u_id, u_pw, u_name, u_regdate, u_grade, u_state) values(users_seq.nextval,'root','1234','root',sysdate, 0 , 0);
select * from users;
...
alter table Qna add(u_name nvarchar2(24));
...
values(0, 0, '나만의도시락', '0', '0', '', 0, sysdate, sysdate);

insert into information(i_no)
values(0)
...
create table cart_list(
   ...
   constraint i_no_cart_list_fk foreign key(i_no) references Information(i_no)
);
...
insert into oder(o_no, o_name, u_no, o_date, o_total, o_state, o_bank) values(Oder_seq.nextval, '나만의도시락', 0, sysdate, 12000, 0, '국민 12121212121212');
insert into oder_menu(on_no, i_no, i_name, o_no, on_cnt, on_state, on_getdate, on_time) values(Oder_menu_seq.nextval, 31, '감자튀김', 1, 2, 0, sysdate+2, '아침');
insert into oder_menu(on_no, i_no, i_name, o_no, on_cnt, on_state, on_getdate, on_time) values(Oder_menu_seq.nextval, 39, '김', 1, 1, 0, sysdate+2, '아침');
insert into oder_menu(on_no, i_no, i_name, o_no, on_cnt, on_state, on_getdate, on_time) values(Oder_menu_seq.nextval, 7, '김치', 2, 2, 0, sysdate+2, '아침');
insert into oder_menu(on_no, i_no, i_name, o_no, on_cnt, on_state, on_getdate, on_time) values(Oder_menu_seq.nextval, 24, '흑미밥', 3, 2, 0, sysdate+2, '아침');
insert into oder_menu(on_no, i_no, i_name, o_no, on_cnt, on_state, on_getdate, on_time) values(Oder_menu_seq.nextval, 40, '김치찌개', 10, 2, 0, sysdate+2, '아침');
insert into oder_menu(on_no, i_no, i_name, o_no, on_cnt, on_state, on_getdate, on_time) values(Oder_menu_seq.nextval, 0, '나만의도시락', 2, 1, 0, sysdate+2, '아침');
insert into lunchbox values(lunchbox_seq.nextval, 31, 5);
insert into lunchbox values(lunchbox_seq.nextval, 39, 5);
insert into lunchbox values(lunchbox_seq.nextval, 7, 5);
insert into lunchbox values(lunchbox_seq.nextval, 24, 5);
insert into lunchbox values(lunchbox_seq.nextval, 40, 5);
...
select * from News n join users u on n.u_no=u.u_no where n_no=#{n_no}